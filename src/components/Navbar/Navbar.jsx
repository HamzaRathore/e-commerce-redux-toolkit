      ...
      <div className="flex flex-col md:flex-row md:justify-around items-center p-4">
        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <p className="font-inter text-base md:text-xl font-medium tracking-normal leading-none text-center pb-4 md:pb-0">
              Shopping Bag
            </p>
            <div>{open && <Cart openModel={open} setOpen={setOpen} />}</div>
          </div>
           {/* Logout Button */}
           <button className="font-inter text-base md:text-xl font-medium tracking-normal leading-none text-center md:mb-0 md:ml-6">
            LogOut
          </button>
        </div>
      </div>
